...
public class WristMenuController : MonoBehaviour
{
    ...
    [Tooltip("Environment mirror; found in the scene if null.")]
    ...
    private void AddPrimitiveShape(PrimitiveType primitiveType)
    {
        ...
        // Identity in the mirror before the listener registration, so the primitive is
        // recorded and the planning-scene sync sees the id as already Unity-owned.
