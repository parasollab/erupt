...
{
    /// <summary>
    /// Builds obstacles with their full component stack and planning-scene registration.
    /// </summary>
    /// <remarks>
    ...
    ///
    /// WristMenuController should delegate here rather than keep its own copy; that edit
    /// is held because the file currently carries uncommitted maintainer changes.
    /// </remarks>
    public static class ObstacleFactory
    {
                                        ...
                                        CollisionObjectsListenerSimple listener = null)
        {
            ...
            var publisher = shape.AddComponent<CollisionObjectPublisher>();
        ...
        /// <summary>Remove an obstacle and its planning-scene registration.</summary>
        /// <param name="publishRemoval">
        /// False when the removal was commanded by ROS, so a REMOVE is not echoed back
        /// into MoveIt's live scene.
        /// </param>
