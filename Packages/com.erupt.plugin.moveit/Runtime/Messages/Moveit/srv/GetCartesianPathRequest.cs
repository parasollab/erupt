...
namespace RosMessageTypes.Moveit
{
    ...
    public class GetCartesianPathRequest : Message
    {
        ...
        public GetCartesianPathRequest(Std.HeaderMsg header, RobotStateMsg start_state, string group_name, string link_name, Geometry.PoseMsg[] waypoints, double max_step, double jump_threshold, double prismatic_jump_threshold, double revolute_jump_threshold, bool avoid_collisions, ConstraintsMsg path_constraints, double max_velocity_scaling_factor, double max_acceleration_scaling_factor, string cartesian_speed_limited_link, double max_cartesian_speed)
        {
            this.header = header;
